...
const int keyMatrixShifted[7][8] =
{
  ...
  { 34,  65,  66,  67,  68,  69,  70, 71}, //{"@","A","B","C","D","E","F","G"},
...
const int keyMatrixSpecial[7][8] =
{
  ...
  {   0,  94,   0,   0, 214, 177,   0,   0}, //{"","^","","","PAGE [D]OWN","[E]SC","",""},
  { 210, 209,   0,   0,   0,   0, 213,   0}, //{"[H]OME","[I]NSERT","","","","","E[N]D",""},
  { 163,   0,   0, 126, 179, 211,   0,   0}, //{"£","","","~","[T]AB","PAGE [U]P","",""},
  {   0,   0,   0,   0,   0, 123, 125,   0}, //{"","","","","","{","}",""},
  {   0,   0,   0,   0,   0,   0,   0,   0}  //{"","","","","","","",""}
};
